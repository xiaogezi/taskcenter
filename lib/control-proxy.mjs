...
const readPaths = new Set(["/health", "/usage-report", "/session-selection", "/gate-session-allowlist", "/session-status", "/routing/health", "/routing/optional-astra-policy", "/reflections", "/dispatches", "/context-management-pilots"]);
const writePaths = new Set(["/sync", "/session-selection", "/gate-session-allowlist", "/gate-session-allowlist/session", "/routing/optional-astra-policy", "/reflections/run", "/context-management-pilots/intents"]);
