...
export function isAllowedControlPath(pathname, method = "GET") {
  ...
  if (method === "POST") return writePaths.has(pathname) || new RegExp(`^/reflections/${reflectionId}/(?:actions|execute)$`).test(pathname) || /^\/context-management-pilots\/[^/]+\/actions$/.test(pathname);
  return false;
}
