...
type PilotProject = { project_id: string; workspace: string; context_management: { state: string; experimental_mode: boolean | "unknown"; observed_at: string; applies_to: string }; latest_intent?: { action: string; status: string; message?: string } | null; trial: { completed: number; target: number; tasks: PilotTask[] } };
